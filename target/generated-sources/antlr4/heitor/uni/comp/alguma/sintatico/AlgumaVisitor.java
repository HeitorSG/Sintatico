// Generated from heitor\u005Cuni\comp\alguma\sintatico\Alguma.g4 by ANTLR 4.7.2
package heitor.uni.comp.alguma.sintatico;
...
public interface AlgumaVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link AlgumaParser#listaDeclaracoes}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitListaDeclaracoes(AlgumaParser.ListaDeclaracoesContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link AlgumaParser#listaComandos}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitListaComandos(AlgumaParser.ListaComandosContext ctx);
	/**
